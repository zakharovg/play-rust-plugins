...
namespace Oxide.Plugins
{
    ...
    public class Clans : RustPlugin
    {
		...
		private MethodInfo kickFriend;
                // Additional command to kick friend instead of deleting friend manually.  Will remove command delete friend from player option.
        ...
        private bool DeleteFriend(string playerId, string friendId) {
            if (lib == null) return false;
            return (bool)kickFriend.Invoke(lib, new object[] { playerId, friendId });
        }
	    
		
        #endregion
		//Added line to delete friend to state instead of just deleting friend the command will kick friend at delete line.
		...
		private bool removeClanMatesAsFriends = true;
        ...
        protected override void LoadDefaultConfig() {
            ...
            Config.Set("removeClanMatesAsFriends", true);
        ...
        void OnServerInitialized() {
            try {
                ...
                try { removeClanMatesAsFriends = Config.Get<bool>("removeClanMatesAsFriends"); } catch { }
            ...
            switch (args[0]) {
                case "create":
                    ...
                    if (player.net.connection.authLevel < 2) {
                        sb.Append(_("You need to be a server owner to create clans."));
                        break;
                    }
                    if (myClan != null) {
                ...
                case "leave":
		            ...
		            foreach (var memberId in myClan.members) {
						if (memberId != userId && IsInstalled() && removeClanMatesAsFriends)
						{
